		...
		<script type="text/javascript">
			$(function(){
				...
				$(".goDetail").click(function(){
					...
					$("#detailForm").attr({
						"method":"get",
						"action":"/admin/board/free/boardFreeDetail"
					});
					$("#detailForm").submit();
				});
				...
				$("#deleteFormBtn").click(function(){
					if(confirm("정말 삭제하시겠습니까?")){
						...
						$.ajax({
							url: "/admin/board/free/deleteAll",
							type: "post",
							traditional : true,
							data: { "numArr" : numArr },
			...
			function goPage(){
				...
				$("#freeSearch").attr({
					"method":"get",
					"action":"/admin/board/free/boardFreeList"
				});
				$("#freeSearch").submit();
			}
							...
							<c:when test="${not empty boardFreeList}">
								<c:forEach var="boardFree" items="${boardFreeList}" varStatus="status">
									<tr class="text-center" data-num="${boardFree.f_num}">
										<td>
											<input type="checkbox" name="deleteCheck" value="${boardFree.f_num}">
										</td>
