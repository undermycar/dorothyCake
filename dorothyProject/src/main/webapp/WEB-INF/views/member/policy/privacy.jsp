...
<%@ include file="/WEB-INF/views/common/common.jspf" %>
	...
	<body>
		<div class="container container--1160">
				...
				'도로시케이크'는 (이하 '회사'는) 고객님의 개인정보를 중요시하며, '정보통신망 이용촉진 및 정보보호'에 관한 법률을 준수하고 있습니다.<br />
...
고객서비스담당 부서 : CS<br />
전화번호 : 02 -123- 5678<br />
이메일 : dorothy_cake@naver.com<br /><br />
개인정보관리책임자 성명 : 김은정<br />
전화번호 : 02 -123- 5678<br />
이메일 : dorothy_cake@naver.com<br /><br />
...
4.경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)<br />						<!-- 개인정보 처리방침 -->
					</div>
				</div>
	</body>
</html>